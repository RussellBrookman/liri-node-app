...
function getTweets(user='ucb_bootcamp_li', limit=20) {
  ...
  client.get('statuses/user_timeline', params, function(error, tweets, response) {
    for (var t in tweets) {
      console.log(colors.blue("[",tweets[t].created_at,"]: ") + tweets[t].text);
    }
  });
}

// ============= SPOTIFY ============ //
function lookupSong(song='All my loving The Beatles', count='5') {
...
// ============= OMDB ================//
function lookupMovie(title='Terminator 2') {
